...
export default function CurriculumSVG(props) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 505 505" style={{enableBackground: 'new 0 0 505 505'}} xmlSpace="preserve" width={505} height={505} {...props}>
