...
export default function UserSVG(props) {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 489.8 489.8" style={{enableBackground: 'new 0 0 489.8 489.8'}} xmlSpace="preserve" width="489.8" height="489.8" {...props}>
      <g>
        <g>
          <polyline id="XMLID_606_" style={{fill: '#3C92CA'}} points="260.2,286.5 268,459.3 244.3,480.7 221,459.6 228.5,286.5 		" />
