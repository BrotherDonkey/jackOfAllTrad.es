...
const Portfolio = (props) => {
  ...
  const githubRepos = props.repos.map((repo, index) =>{
    return (
      <div className="stack-cont portfolio-stack-cont" key={repo.id}>
        ...
        <div className="stack-icon-cont portfolio-icon-cont">
          ...
          <a className="portfolio-github-link" href={repo.html_url} target="_blank" rel="noopener noreferrer">Visit {repo.name} on <br /><img className="portfolio-inline-github-logo" alt="GitHub Logo" src="/icons/png/github.png"/></a>
        </div>
      </div>
    );
  });
  ...
  <div className="profile-cont">
    ...
    <div className="profile-text">
      <a className="profile-link" href={props.userInfo.html_url} target="_blank" rel="noopener noreferrer">
        <p className="profile-login">GitHub: {props.userInfo.login}</p>
  ...
  <h5 className="page-subtitle">- GitHub Repositories -</h5>
